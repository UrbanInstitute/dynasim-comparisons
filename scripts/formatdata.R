...
s1_pc <- read.csv("data/original/PCCurrentLawScheduledT3.csv", stringsAsFactors = F, na=".")
s1_eq <- read.csv("data/original/EQCurrentLawScheduledT3.csv", stringsAsFactors = F, na=".")
s2_pc <- read.csv("data/original/PCPayableT3.csv", stringsAsFactors = F, na=".")
s2_eq <- read.csv("data/original/EQPayableT3.csv", stringsAsFactors = F, na=".")
s3_pc <- read.csv("data/original/PCIncreaseFRAT3.csv", stringsAsFactors = F, na=".")
s3_eq <- read.csv("data/original/EQIncreaseFRAT3.csv", stringsAsFactors = F, na=".")
s4_pc <- read.csv("data/original/PCincreaseFRAERAT3.csv", stringsAsFactors = F, na=".")
s4_eq <- read.csv("data/original/EQIncreaseFRAERAT3.csv", stringsAsFactors = F, na=".")
s5_pc <- read.csv("data/original/PCReduceCOLAT3.csv", stringsAsFactors = F, na=".")
s5_eq <- read.csv("data/original/EQReduceCOLAT3.csv", stringsAsFactors = F, na=".")
s6_pc <- read.csv("data/original/PCPCMiniPIAT3.csv", stringsAsFactors = F, na=".")
s6_eq <- read.csv("data/original/EQMiniPIAT3.csv", stringsAsFactors = F, na=".")
s7_pc <- read.csv("data/original/PCincreaseTaxSSBT3.csv", stringsAsFactors = F, na=".")
s7_eq <- read.csv("data/original/EQincreaseTaxSSBT3.csv", stringsAsFactors = F, na=".")
s8_pc <- read.csv("data/original/PCincreaseTAXMAXT3.csv", stringsAsFactors = F, na=".")
s8_eq <- read.csv("data/original/EQincreaseTAXMAXT3.csv", stringsAsFactors = F, na=".")
...
format <- function(dt) {
  ...
  netinc <- w %>% gather(percentile,"netinc",4:103)
  netinc$percentile = as.character(netinc$percentile)
  netinc <- netinc %>% mutate(percentile=substring(netinc$percentile, 2, nchar(netinc$percentile)))
  ...
  long = left_join(netinc, ss, by=c("year","category","catval", "percentile"))
